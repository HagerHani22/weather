...
class WeatherModel {
  ...
  String toString() {
    return 'tem=$temp minTemp=$minTemp maxTemp=$maxTemp date=$date weatherStateName=$weatherStateName cityName=$cityName icon=$icon';
  }
}
